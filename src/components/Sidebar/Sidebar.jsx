    ...
    return (
        <Box className='box-sidebar'>
            ...
            <Drawer variant="permanent" open={open}>
                ...
                <Divider />
                <List >
                        <ListItem disablePadding className='list-item' component={NavLink} to="/" >
                            <ListItemButton
                    ...
                    <ListItem disablePadding className='list-item' component={NavLink} to="/Yesterday">
                        <ListItemButton
                            className={`list-item-button ${open ? 'open' : 'list-item-button--hidden'}`}
                    ...
                    <ListItem disablePadding className='list-item' component={NavLink} to="/Upcoming">
                        <ListItemButton
                            className={`list-item-button ${open ? 'open' : 'list-item-button--hidden'}`}
                        >
                            <ListItemIcon
